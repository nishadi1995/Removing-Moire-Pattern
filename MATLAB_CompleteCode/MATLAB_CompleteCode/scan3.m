...
figure
imshow(((fftshift(abs(Fimage1)))),[0, 500])
...
figure
imshow(abs(Fimage_modified1),[0, 500])
...
figure
imshow(((fftshift(abs(Fimage2)))),[0, 500])
...
figure
imshow(abs(Fimage_modified2),[0, 500])
...
figure
imshow(((fftshift(abs(Fimage3)))),[0, 500])
...
figure
imshow(abs(Fimage_modified3),[0, 500])
